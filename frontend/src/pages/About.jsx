...
const About = () => {
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 font-sans selection:bg-accent-500/30 overflow-hidden">
      {/* 1. HERO SECTION */}
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-stone-950 via-transparent to-stone-900/30"></div>
        </motion.div>
      ...
      <section className="py-24 px-6 relative">
        <div className="absolute top-1/2 left-0 w-96 h-96 bg-accent-500/10 dark:bg-accent-500/5 rounded-full blur-3xl -z-10"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div 
              ...
              className="relative"
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-stone-200 dark:border-stone-800">
              ...
              <div className="absolute -bottom-10 -right-10 bg-white/80 dark:bg-stone-900/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-stone-100 dark:border-stone-800 hidden md:block">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-accent-500 text-white rounded-2xl flex items-center justify-center">
                    <Award size={32} />
                  </div>
                  <div>
                    <h3 className="text-3xl font-black text-stone-900 dark:text-stone-100">10+</h3>
                    <p className="text-stone-500 dark:text-stone-400 font-medium">Years of Excellence</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              variants={fadeUp}
            >
              <h2 className="text-sm font-bold text-accent-500 tracking-widest uppercase mb-3">Our Mission</h2>
              <h3 className="text-4xl md:text-5xl font-extrabold text-stone-900 dark:text-stone-100 mb-8 leading-tight">
                Empowering travelers to <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-500 to-amber-500">explore with ease.</span>
              </h3>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-stone-100 dark:bg-stone-900 p-5 rounded-2xl border border-stone-200/50 dark:border-stone-800/50">
                  <ShieldCheck size={28} className="text-accent-500 mb-3" />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-1">Trusted & Secure</h4>
                  <p className="text-sm text-stone-500 dark:text-stone-400">Your data and payments are always protected.</p>
                </div>
                <div className="bg-stone-100 dark:bg-stone-900 p-5 rounded-2xl border border-stone-200/50 dark:border-stone-800/50">
                  <Heart size={28} className="text-red-500 mb-3" />
                  <h4 className="font-bold text-stone-900 dark:text-stone-100 mb-1">Crafted with Love</h4>
                  <p className="text-sm text-stone-500 dark:text-stone-400">Every itinerary is tailored to perfection.</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-stone-900 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-accent-900/20 to-transparent pointer-events-none"></div>
      ...
      <section className="py-24 px-6">
        <motion.div
          ...
          variants={fadeUp}
        >
          <h2 className="text-4xl md:text-5xl font-extrabold text-stone-900 dark:text-stone-100 mb-6">
            Meet Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-500 to-amber-500">Leader</span>
          </h2>
          <p className="text-lg text-stone-600 dark:text-stone-400 max-w-2xl mx-auto mb-16">
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <div className="relative bg-white dark:bg-stone-900 p-8 rounded-[3rem] border border-stone-200/50 dark:border-stone-800/50 shadow-xl flex flex-col items-center">
                <div className="w-40 h-40 rounded-full overflow-hidden mb-6 border-4 border-stone-50 dark:border-stone-800 shadow-inner">
                  <img
                ...
                <h3 className="text-2xl font-black text-stone-900 dark:text-stone-100 mb-1">Devllihc</h3>
                <p className="text-accent-500 font-bold uppercase tracking-wider text-sm mb-4">Founder & CEO</p>
                <p className="text-stone-500 dark:text-stone-400 text-center">"Travel is the only thing you buy that makes you richer. Let's make it extraordinary."</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
      ...
      {/* 5. CONTACT SECTION */}
      <section className="py-24 bg-accent-500 dark:bg-accent-600 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl text-accent-100 mb-12 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div key={index} className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-3xl text-white hover:bg-white/20 transition-colors">
                ...
                <p className="text-accent-100">{item.content}</p>
              </div>
            ))}
          </div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-10 py-4 bg-white text-accent-600 rounded-full font-black text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300"
          >
            Contact Us Now
          </a>
        </motion.div>
